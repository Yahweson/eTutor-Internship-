...
export default class DashLecturer extends Component{
    constructor(props){
        super(props);
    ...
    render(){
        return(
            ...
            <div>
                ...
                <p>You are in the Admin Dash Student Component</p>
                        ...
                        <div className="row">
                            <div className=" col-md-3">
                                <div class="list-group">
                                    ...
                                    <a href="#" className="list-group-item"><span className="fas fa-list-alt " aria-hidden="true"></span>View Lecturer</a>
                                    <a href="#" className="list-group-item"><i className="fas fa-align-left"></i><span className="glyphicon glyphicon-pencil" aria-hidden="true"></span>Edit Lecturer</a>
                                    <Link to={"/LecturerAdd/" + this.props.match.params.id} className="list-group-item"><i className="fas fa-user " aria-hidden="true"></i> Add Lecturer and Subject <span className="badge">74</span></Link>
                                </div>
                                <br />
