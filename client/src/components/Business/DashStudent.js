                        ...
                        <div className="row">
                            <div className=" col-md-3">
                                <div class="list-group">
                                    ...
                                    <a href="#" className="list-group-item"><span className="fas fa-list-alt " aria-hidden="true"></span>View Students</a>
                                    <a href="#" className="list-group-item"><i className="fas fa-align-left"></i><span className="glyphicon glyphicon-pencil" aria-hidden="true"></span>Edit Students</a>
                                    <Link to= {"/StudentAdd/" + this.props.match.params.id} className="list-group-item"><span className="fas fa-list-alt " aria-hidden="true"></span>Add Student and Subjects</Link>
                                </div>
                                <br />
