...
export default class SubjectAdd extends Component{
    ...
    render(){
        ...
        if(subjectNo != 0)
        {
            while (subCount < subjectNo) {
                ...
                return (
                    <div>
                        ...
                        <p>You are on the Admin Course Subject Add Component {subCount}</p>
            ...
            return(
                <div>
                    <h1>Continue to Confirm Course Info</h1>
            ...
            return(
                <div>
                    <h1>The Subject was empty return </h1>
                </div>
