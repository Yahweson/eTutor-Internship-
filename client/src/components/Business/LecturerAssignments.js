...
export default class LectureAssignment extends Component{
    constructor(props){
        super(props);
    ...
    render(){
        return(
            ...
            <div>
                ...
                <p>You are in the LectureAssignmentDash Student Component</p>
                        ...
                        <div className="row">
                            <div className=" col-md-3">
                                <div class="list-group">
                                    ...
                                    <a href="#" className="list-group-item"><span className="fas fa-list-alt " aria-hidden="true"></span>View Assignments</a>
                                    <a href="#" className="list-group-item"><i className="fas fa-align-left"></i><span className="glyphicon glyphicon-pencil" aria-hidden="true"></span>Edit Assignments</a>
                                    <Link to= {"/LectureAssignmentAdd/" + this.props.match.params.id} className="list-group-item"><span className="fas fa-list-alt " aria-hidden="true"></span>Add Assignment</Link>
                                </div>
                                <br />
