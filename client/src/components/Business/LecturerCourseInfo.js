...
export default class LecturerCourseInfo extends Component{
    constructor(props){
        super(props);
    ...
    render(){
        return(
            ...
            <div>
                ...
                <p>You are in the LectureCourseInfoDash Student Component</p>
                        ...
                        <div className="row">
                            <div className=" col-md-3">
                                <div class="list-group">
                                    ...
                                    <a href="#" className="list-group-item"><span className="fas fa-list-alt " aria-hidden="true"></span>View Course Info</a>
                                    <a href="#" className="list-group-item"><i className="fas fa-align-left"></i><span className="glyphicon glyphicon-pencil" aria-hidden="true"></span>Edit Course Info</a>
                                    <Link to= "#" className="list-group-item"><span className="fas fa-list-alt " aria-hidden="true"></span>Add Course Info</Link>
                                </div>
                                <br />
