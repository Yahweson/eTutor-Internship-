...
export default class LecturerVideo extends Component{
    constructor(props){
        super(props);
    ...
    render(){
        return(
            ...
            <div>
                ...
                <p>You are in the LectureVideoDash Student Component</p>
                        ...
                        <div className="row">
                            <div className=" col-md-3">
                                <div class="list-group">
                                    ...
                                    <Link to="#" className="list-group-item"><span className="fas fa-list-alt " aria-hidden="true"></span>View Video tutorials</Link>
                                    <Link to="#" className="list-group-item"><i className="fas fa-align-left"></i><span className="glyphicon glyphicon-pencil" aria-hidden="true"></span>Edit Video Tutorials</Link>
                                    <Link to= {"/LecturerVideoAdd/" + this.props.match.params.id} className="list-group-item"><span className="fas fa-list-alt " aria-hidden="true"></span>Add Video Tutorials</Link>
                                </div>
                                <br />
