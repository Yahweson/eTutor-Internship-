...
export default class StudentDash extends Component{
    ...
    render(){
        return(
            <div>
                <p>You are on the StudentDash Component</p>
                <p>Student number</p>
                <section id = "main">
                        ...
                        <div className="row">
                            <div className=" col-md-3">
                                <div class="list-group">
                                    ...
                                    <Link to="#" className="list-group-item"><i className="fas fa-align-left"></i><span className="glyphicon glyphicon-pencil" aria-hidden="true"></span>View Assignments</Link>
                                    <Link to={"/StudentAssignmentAdd/" + this.props.match.params.id }className="list-group-item"><i className="fas fa-user " aria-hidden="true"></i> Add Assignments <span className="badge">74</span></Link>
